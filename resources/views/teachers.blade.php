...
@section('content')
  <div class="px-3">
    <div id="hero-image" class="bg-cover bg-center" style="background-image: url('/img/hero-images/teachers.jpg'); max-width: 100%; width: 100%;">
      <div class="flex flex-col h-full">
        <div class="m-auto text-white uppercase flex flex-col">
          ...
          <p class="hidden sm:flex text-center italic text-2xl text-gray-200 mx-auto px-2 mt-4" style="background-color: rgba(49,49,67,0.4);">highly experienced professionals</p>
        </div>
      </div>
   </div>
  </div>
    ...
    <h2 class="w-5/6 mx-auto text-2xl lg:text-3xl sm:text-3xl text-gray-400 uppercase tracking-wide text-center mt-16 mb-8 px-3">Click a tab to read more</h2>
