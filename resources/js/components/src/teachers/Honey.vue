<template>
  <div class="w-3/4 flex flex-col">
    <div class="w-5/6 mx-auto mb-4">
      <div class="flex">
        <img src="/img/testimonials/testimonial7.jpg" class="md:ml-2 mx-auto h-64 md:h-32 w-64 md:w-32 rounded my-auto object-cover" alt="">
      </div>
    </div>
    ...
    <h3 class="w-5/6 mx-auto text-1xl text-lightblue-300 text-center sm:text-left uppercase text-white tracking-wide mb-8">SENIOR COMPETITIVE TEAM CHOREOGRAPHER at URBANIKS</h3>
